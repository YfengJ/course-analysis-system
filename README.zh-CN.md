...
工作台优先展示课程当前状态、数据接入情况、报告进度和下一步操作，课程以便于扫描的工作队列呈现，不再使用占据首屏的大型展示区。

![课程工作台](docs/images/dashboard.png)

### 证据驱动的达成度分析

分析页按照统计范围、数据来源、关键指标、图表、计算表和人工修订的顺序组织内容，便于快速复核计算结果。

![达成度分析](docs/images/analysis.png)

### 报告检查与导出

报告工作区将检查、编辑、归档和导出操作与报告正文分开，并在正式输出前保留清晰的数据来源标记。
